...
const SettingSideBar = (props) => {
    return(   <div id="right-sidebar" class="settings-panel">
      ...
      >
        ...
        <ul class="chat-list">
          <li class="list active">
            <div class="profile">
              <img src="images/faces/face1.jpg" alt="altpic" />
          ...
          <li class="list">
            <div class="profile">
              <img src="images/faces/face2.jpg" alt="altpic" />
          ...
          <li class="list">
            <div class="profile">
              <img src="images/faces/face3.jpg" alt="altpic" />
              <span class="online"></span>
            </div>
            <div class="info">
              <p>Daniel Russell</p>
          ...
          <li class="list">
            <div class="profile">
              <img src="images/faces/face4.jpg" alt="altpic" />
              <span class="offline"></span>
            </div>
            <div class="info">
          ...
          <li class="list">
            <div class="profile">
              <img src="images/faces/face5.jpg" alt="altpic" />
              <span class="online"></span>
            </div>
            <div class="info">
          ...
          <li class="list">
            <div class="profile">
              <img src="images/faces/face6.jpg" alt="altpic" />
              <span class="online"></span>
            </div>
            <div class="info">
              <p>Sarah Graves</p>
